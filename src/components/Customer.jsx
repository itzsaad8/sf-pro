...
const Customer = () => {
              ...
              // const toggleRole = ()=>{
              //   setRole(position === 'admin' ? 'admin' : 'user')
                  ...
                  <div className='flex justify-between'>
                    ...
                    <div className='flex gap-2 items-center'>
                      <div className='flex gap-2 items-center'>
                        ...
                        <button
                          className={`flex items-center gap-1 px-3 py-1 mb-4 border rounded cursor-pointer ${role === 'admin' ? 'bg-indigo-400 text-white' : ''
                            }`}
                        ...
                        <button
                          className={`flex items-center gap-1 px-3 py-1 mb-4 border rounded cursor-pointer ${role === 'user' ? 'bg-indigo-400 text-white' : ''
                            }`}
                      ...
                      <button className={` flex items-center gap-1 px-3 py-1 mb-4  border rounded cursor-pointer ${sortOrder == 'asc' ? '' : 'bg-indigo-400 text-white'}`} onClick={toggleSortOrder}>
                        <AiOutlineRetweet />
                        ...
                        <a href="/profile">
                          ...
                          <div className='' onClick={() => setData(item)}>
                            ...
                            <ul className='flex items-center justify-between text-center mb-2 shadow-lg p-1 sm:p-3 rounded-lg border border-gray-200 text-[10px] sm:text-base'>
                              ...
                              {/* <li>
                                    <p className=' hidden sm:block font-bold mb-3'>Role</p>{item.role} </li> */}
